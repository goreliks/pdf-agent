...
class InvestigationTask(BaseModel):
    ...
    task_id: str = Field(..., description="Unique identifier for the task, formatted as 'task_{uuid}_{label}'.")
    label: str = Field(..., description="A concise, meaningful label for the task (e.g., 'inspect_object_7').")
